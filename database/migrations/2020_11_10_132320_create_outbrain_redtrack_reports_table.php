...
class CreateOutbrainRedtrackReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('outbrain_redtrack_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('outbrain_redtrack_reports');
    }
}
