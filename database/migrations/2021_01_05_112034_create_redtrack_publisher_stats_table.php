...
class CreateRedtrackPublisherStatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('redtrack_publisher_stats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('redtrack_publisher_stats');
    }
}
