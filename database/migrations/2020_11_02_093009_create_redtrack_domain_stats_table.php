...
class CreateRedtrackDomainStatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('redtrack_domain_stats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('redtrack_domain_stats');
    }
}
