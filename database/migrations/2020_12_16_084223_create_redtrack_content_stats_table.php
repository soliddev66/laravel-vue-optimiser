...
class CreateRedtrackContentStatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('redtrack_content_stats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('redtrack_content_stats');
    }
}
