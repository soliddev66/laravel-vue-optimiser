...
class TaboolaAPI
{
    ...
    public function updateCampaignItem($advertiser_id, $campaign_id, $campaign_item_id, $url, $title, $image, $description)
    {
        return $this->client->call('PUT', $advertiser_id . '/campaigns/' . $campaign_id . '/items/' . $campaign_item_id, [
            'url' => $url,
            'title' => $title,
