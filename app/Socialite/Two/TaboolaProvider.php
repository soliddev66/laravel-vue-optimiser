...
class TaboolaProvider extends AbstractProvider implements ProviderInterface
{
    protected function getAuthUrl($state)
    {
        return $this->buildAuthUrlFromBase('https://backstage.taboola.com/authentication/oauth/authorize', $state);
    }

    protected function getTokenUrl()
    {
        return 'https://backstage.taboola.com/oauth/token';
    }
