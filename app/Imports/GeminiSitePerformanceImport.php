...
class GeminiSitePerformanceImport implements ToArray, WithChunkReading, ShouldQueue, WithHeadingRow, WithEvents, WithBatchInserts
{
    use Importable;
    ...
    public function array(array $rows)
    {
        if (count($rows) > 0) {
            ...
            $resource_importer->insertOrUpdate('gemini_site_performance_stats', $rows, []);
        }
    }
