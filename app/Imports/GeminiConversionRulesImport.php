...
class GeminiConversionRulesImport implements ToArray, WithChunkReading, ShouldQueue, WithHeadingRow, WithEvents, WithBatchInserts
{
    use Importable;
    ...
    public function array(array $rows)
    {
        ...
        $resource_importer->insertOrUpdate('gemini_conversion_rules_stats', $rows, []);
    }
