...
export default {
  ...
  data() {
    ...
    return {
      ...
      adGroupBidUnit: this.instance && this.instance.adGroups.length > 0 ? this.instance.adGroups[0]['bid_unit'] : '',
      adGroupChargeBy: this.instance && this.instance.adGroups.length > 0 ? this.instance.adGroups[0]['charge_by'] : '',
